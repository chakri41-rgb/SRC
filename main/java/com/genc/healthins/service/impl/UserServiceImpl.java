...
public class UserServiceImpl implements UserService {
    ...
    public void deleteById(Long id) {
        ...
        java.util.List<com.genc.healthins.model.Policy> policies = policyRepository.findByUser(user);
        if (policies != null) {
            for (var p : policies) {
        ...
        java.util.List<com.genc.healthins.model.SupportTicket> tickets = supportTicketRepository.findByUser(user);
        if (tickets != null) {
            for (var t : tickets) {
